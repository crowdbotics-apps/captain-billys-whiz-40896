...
## Project Structure
    ...
    ├── captain_billys_whiz_40896  # Django project configurations
...
1. Clone this repo and `cd captain_billys_whiz_40896`
...
2. Clone this repo and `cd captain_billys_whiz_40896`
